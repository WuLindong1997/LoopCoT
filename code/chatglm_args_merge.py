...
if __name__ == "__main__":
    ...
    peft_path1 = "/root/autodl-tmp/wld/model/lora_check_point/apperation_poem_chatglm2/checkpoint-2000/adapter_model.bin"
    peft_path2 = "/root/autodl-tmp/wld/model/lora_check_point/generation_poem_chatglm2/checkpoint-4000/adapter_model.bin"
    ...
    for key in state_dict2.keys():
            state_dict2[key] = (state_dict2[key]+state_dict1[key])/10.0
